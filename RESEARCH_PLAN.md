...
All participants receive the same fixed order and the same predefined stressor schedule. Every task has the timer enabled. The task timer automatically submits an unanswered task when it reaches zero. Social-comparison and negative-feedback messages are fixed per task and are never randomized. Blur, social-comparison, and permission-popup offsets are measured in seconds from task start; each new requested popup or notice begins after 5 seconds and before 20 seconds.
...
| 3 | Legitimate | 40 s | Timer<br>Social comparison (13-17 s)<br>Email blur (7-10 s) | Matching `pge.pl` sender and ordinary invoice context; no request for credentials, payment data, or code. |
| 4 | Legitimate | 30 s | Timer<br>Social comparison (13-17 s)<br>Email blur (7-10 s)<br>Recording notice | Matching `orange.pl` sender, normal account-access context, and no sensitive-data request. |
...
Email blur is only enabled on tasks with a timer of at least 30 seconds. It is delayed until the participant has had time to inspect the sender and subject, then shown for three seconds. Task-level popup and notice offsets are fixed by the experiment plan and are never randomized in the browser.
...
- **Stressors:**
  - Timer
  - Social comparison, displayed after 7 seconds for 5 seconds: `Odpowiadasz wolniej niż 74% uczestników.`
...
- **Stressors:**
  - Timer
  - Email blur from 7 to 10 seconds after task start
  - Social comparison, displayed after 13 seconds for 4 seconds: `Inni uczestnicy zwykle szybciej kończą to zadanie.`
- **Legitimacy indicators:**
...
- **Stressors:**
  - Timer
  - Email blur from 7 to 10 seconds after task start
  - Social comparison, displayed after 13 seconds for 4 seconds: `67% uczestników podjęło już decyzję.`
  - Recording notice
- **Legitimacy indicators:**
...
- **Stressors:**
  - Timer
  - Social comparison, displayed after 7 seconds for 4 seconds: `Twoje tempo jest niższe niż średnia w tej części badania.`
  - Recording notice
...
- **Stressors:**
  - Timer
  - Email blur from 7 to 10 seconds after task start
  - Social comparison, displayed after 13 seconds for 4 seconds: `Uczestnicy przed Tobą zwykle odpowiadają szybciej.`
  - Recording notice
...
- **Stressors:**
  - Timer
  - Social comparison, displayed after 7 seconds for 4 seconds: `Pozostało Ci mniej czasu niż większości uczestników.`
  - Recording notice
...
- **Stressors:**
  - Timer
  - Social comparison, displayed after 6 seconds for 4 seconds: `78% uczestników podjęło już decyzję.`
  - Recording notice
  ...
  - Microphone permission popup, shown 10 seconds after task start
- **Indicators of compromise:**
...
- **Stressors:**
  - Timer
  - Social comparison, displayed after 6 seconds for 4 seconds: `Jesteś wśród wolniejszych odpowiedzi w tej serii.`
  - Recording notice
  ...
  - Camera permission popup, shown 10 seconds after task start
- **Legitimacy indicators:**
...
- **Stressors:**
  - Timer
  - Social comparison, displayed after 6 seconds for 4 seconds: `Większość uczestników zakończyła już podobne zadanie.`
  - Recording notice
  ...
  - Microphone permission popup, shown 10 seconds after task start
  - Camera permission popup, shown 11 seconds after task start
- **Indicators of compromise:**
